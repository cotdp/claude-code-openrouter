 ...
 *
 * Vendored from OpenRouterTeam/openrouter-examples (claude-code/statusline.ts);
 * unchanged apart from this attribution notice.
 * Copyright (c) 2023 OpenRouter — MIT License.
